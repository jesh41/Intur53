...
//grupos
    ...
    Route::group(['middleware' => 'permissionshinobi:reportes'], function () {
        ...
        Route::get('/crear_reporte_anulaciones/{tipo}/{anio}', 'ReportController@crear_pdf_anulaciones');
        Route::get('/crear_reporte_Libros/{tipo}/{anio}', 'ReportController@crear_pdf_libros');
    });
