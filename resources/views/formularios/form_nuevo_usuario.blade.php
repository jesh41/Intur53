<!-- Modal -->
                <form method="post" action="/crear_usuario" id="f_crear_usuario">
                    ...
                    <div class="modal-body clearfix">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="col-sm-3" for="email">Correo</label>
                                <div class="col-sm-9">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="col-sm-3" for="email">Nombre</label>
                                <div class="col-sm-9">
                        ...
                        <div class="col-md-6" id="text-categoria" style="visibility:hidden">
                            <div class="form-group">
                                <label class="col-sm-5 control-label">Categoria hotel</label>
                                <div class="col-sm-7">
                        ...
                        <div class="col-md-6" id="text-nombre" style="visibility:hidden">
                            <div class="form-group">
                                <label class="col-sm-5" for="nombre">Nombre Hotel</label>
                                <div class="col-sm-7">
                        ...
                        <div class="col-md-6" id="text-telefono" style="visibility:hidden">
                            <div class="form-group">
                                <label class="col-sm-5" for="nombre">Telefono</label>
                                <div class="col-sm-7">
                        ...
                        <div class="col-md-6" id="text-direc" style="visibility:hidden">
                            <div class="form-group">
                                <label class="col-sm-4" for="nombre">Direccion</label>
                                <div class="col-sm-8">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-default">Crear Nuevo Usuario</button>
